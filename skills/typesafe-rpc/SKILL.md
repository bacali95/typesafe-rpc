...
For real-time server-push/subscriptions over WebSocket, see the companion `typesafe-ws` package (`skills/typesafe-ws/SKILL.md`) in this same repo — `typesafe-rpc` itself is HTTP request/response only.
